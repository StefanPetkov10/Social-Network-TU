...
namespace SocialMedia.Migrations
{
    ...
    [Migration("20260321131938_AddYouTubeUrlToPost")]
    partial class AddYouTubeUrlToPost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMedia.Database.Models.Message", b =>
                {
                    ...
                    b.HasOne("SocialMedia.Database.Models.Profile", "Receiver")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SocialMedia.Database.Models.Profile", "Sender")
            ...
            modelBuilder.Entity("SocialMedia.Database.Models.MessageMedia", b =>
                {
                    b.HasOne("SocialMedia.Database.Models.Message", "Message")
                        .WithMany("Media")
            ...
            modelBuilder.Entity("SocialMedia.Database.Models.Notification", b =>
                {
                    b.HasOne("SocialMedia.Database.Models.Profile", "Recipient")
                        .WithMany("NotificationsReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialMedia.Database.Models.Profile", "TriggeredBy")
            ...
            modelBuilder.Entity("SocialMedia.Database.Models.ReportedPost", b =>
                {
                    ...
                    b.HasOne("SocialMedia.Database.Models.Profile", "Reporter")
                        .WithMany()
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SocialMedia.Database.Models.Profile", "ResolvedBy")
                        .WithMany()
